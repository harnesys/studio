...
1. **Проверить документацию** (`docs/01`–`docs/22`). Если тип/функция не описаны — не добавлять, вынести на обсуждение.
2. **Проверить библиотеку** — возможно тип уже есть inline, под другим именем, или другой подход решает задачу. Не дублировать.
3. **Сравнить с Harnyx** (`/Users/mikestotik/Projects/Harnyx`) — понять что изменилось и почему. Не копировать подходы Harnyx, если Harnesys использует другой механизм.
...
- Копировать подходы из Harnyx, если docs описывают другой механизм
