  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        ...
        'data-[variant=segment]:h-7 data-[variant=segment]:max-w-fit data-[variant=segment]:gap-0 data-[variant=segment]:rounded-lg data-[variant=segment]:bg-muted data-[variant=segment]:p-[2px]',
        className,
      )}
      {...props}
    >
