#!/usr/bin/env bun
/**
 * Vendors canonical plugin-format schemas into packages/harnesys.
 * Per file: fetch (redirects followed), hash the canonical JSON before
 * annotations, write with x-vendored-from (final URL after redirects)
 * and x-vendored-sha256 on top.
 */
...
/** Canonical form used for hashing: 2-space JSON plus trailing newline. */
