...
export function AgentHooksPane({
  ...
  return (
    <section className="flex min-w-0 flex-col gap-2" data-testid="agent-hooks-pane">
      {hooks.length === 0 ? (
      ...
      <Button type="button" variant="outline" size="sm" className="self-start" onClick={addHook}>
        <PlusIcon />
        Add hook
      </Button>
    </section>
