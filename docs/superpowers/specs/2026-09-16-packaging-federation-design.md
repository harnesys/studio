...
- Клик по табу-аватару и пункт в ⋯ = toggle on/off, без shift/control. Секции показывают группы всех включённых workspace с разделителем (имя + count). Канон: `docs/superpowers/specs/2026-09-17-multi-workspace-desk-design.md`.
